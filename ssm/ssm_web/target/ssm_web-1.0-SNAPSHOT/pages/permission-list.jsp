	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/role/findAll">资源权限管理</a></li>
									...
									<c:forEach items="${permissions}" var="permission">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permission/deletePermissionById?id=${permission.id}" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
